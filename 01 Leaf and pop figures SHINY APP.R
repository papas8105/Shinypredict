...
# iN CASE wdi API fails load
#  load("C:/Pablo UK/43 R projects 2020/04 My Shiny app/04 Mycovid19 app/POP_FIGURES_FINAL.RData")
## C:\Pablo UK\43 R projects 2020\04 My Shiny app\04 Mycovid19 app\08 POP FIGURES BACKUP
getwd()
# PLOT_POP_RATESC.csv
...
#
# CONFR =ceiling((ifelse(ConfM==0,0,ConfM/population)*100000)),
# DEATHR =ceiling( (ifelse(DeathfM==0,0,DeathfM/population)*100000)),
# RECR = ceiling((ifelse(RecfM==0,0,RecfM/population)*100000)),
#
#
...
POPG_RATESF <- POPG_RATES %>% 
  ...
  mutate(
            CONFR =ceiling(((ConD/population)*100000)),
            RECR = ceiling(((RecD/population)*100000)),
            DEATHR =ceiling(((DeathD/population)*100000))
        )
...
# [1] "date"       "Country"    "population" "ConD"       "RecD"       "DeathD"     "CONF_ma07"  "REC_ma07"  
# [9] "DEATH_ma07"

# Clean variables (rename them) 
# New_name = Old_name
...
POP_POPULATED_prev <- POP_POPULATEDT %>% 
                 select(
                        date,Country,Population,Confirmed,Recovered,Death,
                        Confirmed_10000,Recovered_10000,Deaths_10000)
...
save.image("C:/Pablo UK/43 R projects 2020/04 My Shiny app/04 Mycovid19 app/RATES_FOR_SHINY_APP_FINAL.Rdata")
